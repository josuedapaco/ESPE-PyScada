...
{% block title %}{{ view_title }} -  Control Center{% endblock %}
...
{% block body_confic_data %} data-data-file="json/cache_data/" data-view-title="{{ view_link_title }}" data-view-time-delta="{{ view_time_delta }}" {% endblock %}
